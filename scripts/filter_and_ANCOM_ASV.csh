...
echo "Starting filter and ANCOM analysis for FAPROTAX"
date
...
qiime composition add-pseudocount \
 ...
 --o-composition-table  ${PREFIX}_${SUFFIX}_comp.qza

qiime composition ancom \
 --i-table ${PREFIX}_${SUFFIX}_comp.qza\
 --m-metadata-file ${METADATA}\
 --m-metadata-column ${COL1}\
 --o-visualization ${PREFIX}_${SUFFIX}_comp_${COL1}.qzv
